...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtUtil jwtUtil, UserDetailsService userDetailsService) throws Exception {
        ...
        .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/books/*/file").hasAnyRole("ADMIN", "EMPLOYEE", "USER")
                .requestMatchers(HttpMethod.POST, "/books/*/file").hasAnyRole("ADMIN", "EMPLOYEE")
                .requestMatchers(HttpMethod.GET, "/books/**").hasAnyRole("ADMIN","EMPLOYEE","USER")
                .requestMatchers(HttpMethod.POST, "/books/**").hasAnyRole("ADMIN","EMPLOYEE")
                .requestMatchers(HttpMethod.PATCH, "/books/**").hasAnyRole("ADMIN","EMPLOYEE")
                .requestMatchers(HttpMethod.DELETE, "/books/**").hasAnyRole("ADMIN")
                .requestMatchers("/genres/**").hasAnyRole("ADMIN","EMPLOYEE")
